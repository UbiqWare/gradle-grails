...
set AGENT_STRING=-javaagent:%GRAILS_HOME:\=/%/lib/org.springframework/springloaded/jars/springloaded-1.2.3.RELEASE.jar -Xverify:none -Dspringloaded.synchronize=true -Djdk.reflect.allowGetCallerClass=true -Dspringloaded=\"%SPRINGLOADED_PARAMS%\"
...
set STARTER_CLASSPATH=%GRAILS_HOME%\lib\org.codehaus.groovy\groovy-all\jars\groovy-all-2.3.11.jar;%GRAILS_HOME%\dist\grails-bootstrap-2.4.5.jar
